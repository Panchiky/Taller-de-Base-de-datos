...
(
  codigodependencias INT NOT NULL,
  dependencia VARCHAR(255) NOT NULL,
  PRIMARY KEY (codigodependencias)
);
...
(
  idrencionpruebas INT NOT NULL,
  rendicionesprueba VARCHAR(255) NOT NULL,
  PRIMARY KEY (idrencionpruebas)
);
...
(
  ...
  FOREIGN KEY (codigodependencias) REFERENCES DEPENDENCIAS(codigodependencias)
);
...
(
  ...
  codigoramaeducacional CHAR(2) NOT NULL,
  rbd INT NOT NULL,
  PRIMARY KEY (codigo_ens, codigoramaeducacional, rbd),
  FOREIGN KEY (codigo_ens) REFERENCES TIPOSENSENANZA(codigo_ens),
  FOREIGN KEY (codigoramaeducacional) REFERENCES RAMASEDUCACIONALES(codigoramaeducacional),
  FOREIGN KEY (rbd) REFERENCES ESTABLECIMIENTOS(rbd)
);
...
(
  ...
  promedio FLOAT NOT NULL CHECK (promedio >= 0 AND promedio <= 100), 
  ...
  cod_sexo INT NOT NULL,
  PRIMARY KEY (mrut),
  FOREIGN KEY (codigo_ens, codigoramaeducacional, rbd) REFERENCES TIPOSENSENANZA_ESTABLECIMIENTOS(codigo_ens, codigoramaeducacional, rbd),
...
(
  ...
  mrut INT NOT NULL,
  idpruebas INT NOT NULL,
  PRIMARY KEY (idrencionpruebas, mrut, idpruebas),
  FOREIGN KEY (idrencionpruebas) REFERENCES RENDICIONESPRUEBAS(idrencionpruebas),
  FOREIGN KEY (mrut) REFERENCES POSTULANTES(mrut),
  FOREIGN KEY (idpruebas) REFERENCES PRUEBAS(idpruebas)
);
